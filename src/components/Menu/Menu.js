    ...
    return (
      <div onClick={clickContextMenu}>
        <ul className="menu" style={{ top: anchorPoint.y, left: anchorPoint.x }}>
          ...
          {/* <hr /> */}
          <form>
            <Button variant="contained" type="submit" className="btn btn-light" onClick={deleteSection} style={{ height: "15" }}>
              Delete
            </Button>
          </form>
          ...
          <form className="formContainer">
            ...
            <Button variant="contained" type="submit" className="btn btn-success" style={{ width: "15%", height: "80%" }} onClick={updateSection}>
