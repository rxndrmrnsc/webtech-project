    ...
    return (
      <div onClick={clickContextMenu}>
        <ul className="menu" style={{ top: anchorPoint.y, left: anchorPoint.x }}>
          ...
          {/* <hr /> */}
          <form>
            <Button variant="contained" color="error" type="submit" className="btn btn-light" onClick={deleteSection} style={{ height: "15" }}>
              Delete
            </Button>
          </form>
          ...
          <form className="formContainer">
            ...
            <input type="text" className="newName" style={{ width: "80%", height: "15", color: "black" }} onChange={getNewName} />
            <Button variant="contained" color="success" type="submit" className="btn btn-success" style={{ width: "15%", height: "80%" }} onClick={updateSection}>
